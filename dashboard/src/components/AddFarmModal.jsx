  ...
  return (
    <div className="fixed inset-0 z-[2000] flex items-center justify-center bg-black/30 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md mx-4 p-6">
        <h3 className="text-lg font-bold text-gray-900 mb-5">Add Farm Site</h3>

        {/* Name */}
        <label className="block text-xs font-semibold text-gray-500 mb-1.5">Farm Name</label>
        <input
          type="text"
          autoFocus
          value={name}
          ...
          className="w-full px-4 py-2.5 rounded-xl bg-[#f1f0f9] border border-gray-200 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-violet-300 focus:border-violet-400 mb-4"
        />
        ...
        {!useNewGroup && existingGroups.length > 0 ? (
          <select
            ...
            className="w-full px-4 py-2.5 rounded-xl bg-[#f1f0f9] border border-gray-200 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-violet-300 focus:border-violet-400 mb-4"
          >
        ...
        <div className="flex justify-end gap-2 mt-2">
          <button
            onClick={onCancel}
            className="px-5 py-2.5 text-sm rounded-xl bg-gray-100 text-gray-500 font-medium hover:bg-gray-200 transition-colors"
          >
            Cancel
          </button>
          <button
